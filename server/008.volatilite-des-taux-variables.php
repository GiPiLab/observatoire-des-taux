...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$.getJSON(req, function(data, status) {
				...
				var pieData_ester = countOccByInterval(data["ester"], 5);
				...
				$("#numPartsButton").on("click", function() {
					...
					$("#message4").show(400, function() {
						pieData_ester = countOccByInterval(data["ester"], parseInt(numPartsValue));
						...
						chart4.get("ester").setData(pieData_ester);
		...
		var jqxhr = $.getJSON(req, function(data, status) {
				...
				chart3 = new Highcharts.Chart({
					...
					title: {
						text: 'Volatilité des taux variables'
					},
					...
					series: [{
							name: "Ester",
							visible: false,
							data: data["ester"]["data"],
							nbOcc: data["ester"]["nbOcc"]
						},
						{
							name: "Eonia",
							visible: false,
			...
			<div class="row">
				...
				<div class="col l8 s12">
					...
					<div class="center-align">
						<label>
							<input name="group3" type="radio" class="with-gap" id="ester" value="ester" />
							<span>Ester</span>
						</label>
						<label>
