...
$(document).ready(function(){
      ...
      exporting:{
		...
		text:"Enregistrer au format PNG",
			...
			onclick:function(){
				...
				setTimeout(function(){chart2.exportChartLocal();$("body").removeClass("loading");},1000);
			}
		}],
		}
	}
   ...
   $("#message2").hide();
      ...
      $('[name="group1"]').on("change",function(){
	      if(this.checked)
	      {
		      ...
		      serie.show();
		      chart2.setTitle({text:"Répartition des taux fixes"},{text:serie.name});
	      }
      });
  ...
  var jqxhr=$.getJSON(req,function(data,status){
     ...
     chart1 = new Highcharts.Chart({
      exporting:{
		...
		text:"Enregistrer au format PNG",
			...
			onclick:function(){
				$("body").addClass("loading");	
				setTimeout(function(){chart1.exportChartLocal();$("body").removeClass("loading");},1000);
			}
		}],
		}
	}
	...
	animation:false,
      ...
      title: {text: 'Volatilité des taux fixes'},
